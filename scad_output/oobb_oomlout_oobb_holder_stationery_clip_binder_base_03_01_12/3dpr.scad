			...
			rotate(a = [180, 0, 0]) {
				difference() {
					...
					union() {
						...
						translate(v = [0, -4, -2.0000000000]) {
							cylinder(h = 2, r = 8.5000000000);
						}
						#translate(v = [-22.5000000000, 4.2500000000, -0.7500000000]) {
							cube(size = [45, 1.5000000000, 1.5000000000]);
						}
					}
				}
			}
